    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("TA3MQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("TA3MQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("TA3MQQueues_History", "QUEUEID", "QUEUEID")
							.Select("TA3MQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("TA3MQQueues_History", "ANO", "ANO")
                            .Select("TA3MQQueues_History", "USERNAME", "USERNAME")
                            .Select("TA3MQQueues_History", "TABELA", "TABELA")
                            .Select("TA3MQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("TA3MQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("TA3MQQueues_History", "QUEUE", "QUEUE")
                            .Select("TA3MQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("TA3MQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("TA3MQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("TA3MQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("TA3MQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("TA3MQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("TA3MQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("TA3MQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("TA3MQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.TA3MQQueues_History";
