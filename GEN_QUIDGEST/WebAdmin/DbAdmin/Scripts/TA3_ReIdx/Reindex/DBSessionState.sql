...
SET @SQL = N'
CREATE DATABASE [ASPStateTA3]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStateTA3'', FILENAME = N''' + @SQLDataFolder + 'ASPStateTA3.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStateTA3_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStateTA3_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStateTA3_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStateTA3_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStateTA3_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStateTA3] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStateTA3] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
