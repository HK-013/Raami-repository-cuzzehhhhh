...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("TA3", "userauthorization", "userauthorization", "codua", "codpsw", "TA3", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL TA3 TABAUX UserAuthorization]/
