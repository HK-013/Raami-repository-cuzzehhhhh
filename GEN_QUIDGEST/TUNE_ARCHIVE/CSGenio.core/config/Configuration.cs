...
namespace CSGenio.framework
{
    ...
    public static class Configuration
    {
        ...
        /// System id
        /// </summary>
        public static string Program { get; } = "TA3";

        /// <summary>
        /// Application subsystem
        /// </summary>
        public static readonly ClientApplication Application = ClientApplication.TUNE_ARCHIVE;

        /// <summary>
        /// Modules
        /// </summary>
        public static readonly List<string> Modules = ["TA3"];
        ...
        {
			// USE /[MANUAL TA3 RESOLVEDATASYSTEM]/
            DataSystemXml ds;
            switch (db)
            {
