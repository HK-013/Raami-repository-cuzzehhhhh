...
// USE /[MANUAL TA3 INCLUDE_CONTROLLER CHASSIS_CODE]/

namespace GenioMVC.Controllers
{
	public partial class Chassis_codeController : ControllerBase
	{
		private IChatbotService _aiService;
		public Chassis_codeController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TA3 CONTROLLER_NAVIGATION CHASSIS_CODE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAchassis_code>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TA3 MANUAL_CONTROLLER CHASSIS_CODE]/
		...
		{
			return base.GetDocumsTickets("CHASSIS_CODE", requestModel.FieldName, requestModel.KeyValue);
		}
