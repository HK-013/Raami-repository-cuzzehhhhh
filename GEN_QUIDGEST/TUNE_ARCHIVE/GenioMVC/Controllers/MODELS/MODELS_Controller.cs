...
// USE /[MANUAL TA3 INCLUDE_CONTROLLER MODELS]/
...
namespace GenioMVC.Controllers
{
	public partial class ModelsController : ControllerBase
	{
		...
		public ModelsController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TA3 CONTROLLER_NAVIGATION MODELS]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAmodels>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TA3 MANUAL_CONTROLLER MODELS]/
		...
		{
			return base.GetDocumsTickets("MODELS", requestModel.FieldName, requestModel.KeyValue);
		}
