...
// USE /[MANUAL TA3 INCLUDE_CONTROLLER MAKE]/

namespace GenioMVC.Controllers
{
	public partial class MakeController : ControllerBase
	{
		private IChatbotService _aiService;
		public MakeController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TA3 CONTROLLER_NAVIGATION MAKE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAmake>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TA3 MANUAL_CONTROLLER MAKE]/
		...
		{
			return base.GetDocumsTickets("MAKE", requestModel.FieldName, requestModel.KeyValue);
		}
