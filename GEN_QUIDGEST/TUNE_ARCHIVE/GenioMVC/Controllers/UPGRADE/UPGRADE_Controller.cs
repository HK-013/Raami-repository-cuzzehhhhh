...
// USE /[MANUAL TA3 INCLUDE_CONTROLLER UPGRADE]/
...
namespace GenioMVC.Controllers
{
	public partial class UpgradeController : ControllerBase
	{
		...
		public UpgradeController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TA3 CONTROLLER_NAVIGATION UPGRADE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAupgrade>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TA3 MANUAL_CONTROLLER UPGRADE]/
		...
		{
			return base.GetDocumsTickets("UPGRADE", requestModel.FieldName, requestModel.KeyValue);
		}
